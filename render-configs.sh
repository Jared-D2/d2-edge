...
# NOTE: oob-console (ser2net) rendering intentionally does NOT live here —
# setup-oob.sh renders ports.yaml → rendered/ser2net.yaml + slots.rules
# itself, so the udev fragment is produced and installed in the same deploy
# step (review 2026-08-13 finding #3: the split cost a full extra deploy).
